...
var _user$project$Router$parseLocation = function (location) {
	...
	if (_p1.ctor === 'Just') {
		...
		return _user$project$Router$Home;
	}
};
...
var _user$project$Main$onClickPage = F2(
	function (route, current) {
		var is_active = _elm_lang$core$Native_Utils.eq(route, current);
		return {
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$href(
				_user$project$Router$routeToUrl(route)),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$classList(
					{
						...
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'link--active', _1: is_active},
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					...
					_0: _user$project$Main$onPreventDefaultClick(
						_user$project$Main$NewRoute(route)),
					_1: {ctor: '[]'}
				}
			}
		};
	});
var _user$project$Main$header = function (current_view) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								A2(_user$project$Main$onClickPage, _user$project$Router$Home, current_view),
								{
									ctor: '::',
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Main$header(model.currentView),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
